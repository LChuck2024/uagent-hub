...
/** Resolve system prompt from tenant store when tenantSlug is present (never trust client prompt). */
export async function resolveChatConfig(body, readTenantFn, isValidSlugFn) {
